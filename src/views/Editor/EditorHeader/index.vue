  ...
  <div class="editor-header">
    <div class="left">
      <Popover trigger="click" placement="bottom-start" v-model:value="mainMenuVisible">
        <template #content>
          <PopoverMenuItem @click="openAIPPTDialog(); mainMenuVisible = false" v-if="false">AI 生成 PPT（测试版）</PopoverMenuItem>
          ...
          <PopoverMenuItem @click="goLink('https://github.com/idaima/PPTist/issues')">意见反馈</PopoverMenuItem>
          <PopoverMenuItem @click="goLink('https://github.com/idaima/PPTist/blob/master/doc/Q&A.md')">常见问题</PopoverMenuItem>
    ...
    <div class="right">
      ...
      <div class="menu-item" v-tooltip="'AI生成PPT'" @click="openAIPPTDialog(); mainMenuVisible = false" v-if="false">
        <span class="text">AI</span>
      </div>
      <div class="menu-item" v-tooltip="'导出'" @click="setDialogForExport('pptx')">
        <IconDownload class="icon" />
      </div>
      <a class="github-link" v-tooltip="'Copyright © 2020-PRESENT pipipi-pikachu'" href="https://github.com/idaima/PPTist" target="_blank">
